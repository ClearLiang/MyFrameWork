...
import com.example.a99794.framework.testfile.LocationInterface;
...
public class LocationUtil {
    ...
    public static LocationUtil getLocationUtil(Context context) {
        mContext = context;
        return LocationUtilHolder.sLocationUtil;
    }
    ...
    private class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            mLocationInterface.getLocationMessage(location);
    ...
    public void getMessage(LocationInterface locationInterface){
        startLocate();
